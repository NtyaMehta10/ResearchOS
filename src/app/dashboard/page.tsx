        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              <EmptyState icon={Pin} title="No favorite projects" description="Star a project to pin it here." />
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {projects
                  .filter((p) => p.isFavorite)
                  .map((p) => (
                    <Link key={p.id} href={`/projects/${p.id}`} className="block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-xl transition-shadow">
          ...
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              <EmptyState icon={FolderKanban} title="No active research projects" description="Create your first research workspace to begin." />
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {projects.map((p) => (
                  <Link key={p.id} href={`/projects/${p.id}`} className="block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-xl transition-shadow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card>
                <CardHeader className="p-5 pb-3 flex flex-row items-center justify-between border-b border-border/60">
                  ...
                  >
                    <span className="flex items-center gap-1">View all <ArrowRight className="w-3 h-3" /></span>
                  </Link>
                </CardHeader>
                <CardContent className="p-3 divide-y divide-border/40">
                  {loading ? (
                    ...
                    <div className="p-4"><EmptyState icon={FileText} title="No documents yet" description="Upload a document to get started." /></div>
                  ) : (
              ...
              <Card>
                ...
                <CardContent className="p-3 divide-y divide-border/40">
                  {loading ? (
                    ...
                    <div className="p-4"><EmptyState icon={StickyNote} title="No notes yet" description="Write your first research note." /></div>
                  ) : (
            ...
            <Card className="h-full flex flex-col">
              <CardHeader className="p-5 pb-3 flex flex-row items-center justify-between border-b border-border/60">
                ...
                >
                  <span className="flex items-center gap-1">Full timeline <ArrowRight className="w-3 h-3" /></span>
                </Link>
              </CardHeader>
              <CardContent className="p-4 flex-1 overflow-y-auto min-h-[300px]">
                {loading ? (
                  ...
                  <div className="h-full flex items-center justify-center py-6"><EmptyState icon={Clock} title="No activity" description="Recent actions will appear here." /></div>
                ) : (
...
{/* Needs Attention Section */}
        {(inboxItems.length > 0 || tasks.length > 0) && (
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-lg font-bold text-foreground">
            ...
            <Card>
              ...
              <CardContent className="p-3 divide-y divide-border/40">
                {loading ? (
                  ...
                  <div className="p-4"><EmptyState icon={FileText} title="Inbox zero" description="You have no unread notifications." /></div>
                ) : (
            ...
            <Card>
              ...
              <CardContent className="p-3 divide-y divide-border/40">
                {loading ? (
                  ...
                  <div className="p-4"><EmptyState icon={FolderKanban} title="No active tasks" description="You are all caught up." /></div>
                ) : (
